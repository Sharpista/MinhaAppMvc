...
namespace DevIO.App2.Controllers
{
    public class ProdutosController : BaseController
    {
        ...
        private async Task<ProdutoViewModel> ObterProduto(Guid id)
        {
            ...
            produto.Fornecedores = _mapper.Map<IEnumerable<FornecedorViewModel>>(await _fornecedorRepository.ListarTodosAync());

            return produto;
        }
        private async Task<ProdutoViewModel> PopularForncedores(ProdutoViewModel produtoViewModel)
        {
            produtoViewModel.Fornecedores = _mapper.Map<IEnumerable<FornecedorViewModel>>(await _fornecedorRepository.ListarTodosAync());
